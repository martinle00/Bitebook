            ...
            <div className="space-y-4 bg-gray-50 p-4 rounded-lg">
              ...
              {place.fullAddress && (
                <div>
                  ...
                  <div className="flex items-center gap-2 text-gray-600 bg-white p-2 rounded border">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {place.isPermanentlyClosed ? (
                    ...
                    openStatus !== null && (
                      <Badge 
                        variant="secondary" 
                        className={openStatus ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}
                      >
